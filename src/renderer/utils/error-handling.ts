...
export const ErrorCodes = {
  ...
  MCP_PROVIDER_INITIALIZATION_FAILED: "MCP_PROVIDER_INITIALIZATION_FAILED",
  MCP_CONTEXT_NOT_FOUND: "MCP_CONTEXT_NOT_FOUND",
  MCP_CONTEXT_CREATION_FAILED: "MCP_CONTEXT_CREATION_FAILED",
  MCP_MESSAGE_SEND_FAILED: "MCP_MESSAGE_SEND_FAILED",
  MCP_PROTOCOL_VIOLATION: "MCP_PROTOCOL_VIOLATION",
